        ...
        if (window.location.search != "") {
          ...
          switch (site) {
            ...
            case "login":
              ...
              break;
            case "registrieren":
             // app.router.navigate('/registrieren/');
              break;
            case "ueber":
              app.router.navigate('/ueber/');
              break;
            case "dsvgo":
              app.router.navigate('/dsvgo/');
              break;
            case "datenschutz":
              app.router.navigate('/datenschutz/');
              break;
            case "partner":
              app.router.navigate('/partner/');
              break;
            case "impressum":
              app.router.navigate('/impressum/');
              break;
            case "newsletter":
              app.router.navigate('/newsletter/');
              break;
            case "kontakt":
              app.router.navigate('/kontakt/');
              break;
            case "spenden":
              app.router.navigate('/spenden/');
              break;
            case "agb":
              app.router.navigate('/agb/');
              break;
            case "hilfe":
              app.router.navigate('/hilfe/');
              break;
            case "rss":
              app.router.navigate('/rss/');
              break;
            case "mitglieder":
              app.router.navigate('/mitglieder/');
              break;

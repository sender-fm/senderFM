   ...
   methods: {
      ...
      radioINIT: function() {
         ...
         app.data.radio = new Radio([{
            ...
            src: ['https://senderfm.out.airtime.pro/senderfm_a', 'https://senderfm.out.airtime.pro/senderfm_a'],
            howl: null
         }]);
      },
...
$$(document).on('click', '#goodnews_save-right', function(e) {
   ...
   app.request.post('php/action_content_goodnews.php', {
      ...
      if (data == "OK") {
         toast_saved.open();
         $$(".ql-editor").html("");
         alert("lade alle admin goodnews für die rechte seite")
         app.loadAdminGoodnews();
         alert("admin hinweis: hier sollte sortiert werden / nur beiträge der rechten seite laden")
